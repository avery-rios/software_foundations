...
Theorem rev_exercise1 : forall (l l' : list nat),
  ...
  l' = rev l.
Proof.
  intros l l' E. rewrite E. symmetry. apply rev_involutive.
Qed.
(** [] *)
...
Example trans_eq_exercise : forall (n m o p : nat),
     ...
     (n + p) = (minustwo o).
Proof.
  intros n m o p Em Enp. transitivity m. 
  - apply Enp.
  - apply Em.
Qed.
(** [] *)
...
Proof.
  ...
  injection E1 as Exz Ej. rewrite Exz.
  assert (El : y :: l = z :: l). { transitivity j. apply Ej. apply E2. }
  injection El as Eyz. symmetry. apply Eyz.
Qed.
(** [] *)
...
Example discriminate_ex3 :
  forall (X : Type) (x y z : X) (l j : list X),
    ...
    x = z.
Proof.
  intros X x y z l j E. discriminate E.
Qed.
(** [] *)
...
Proof.
  ...
  - intros m E. destruct m as [| m'].
    + discriminate E.
    + f_equal. apply IHn. simpl in E. apply E.
Qed.
(** [] *)
...
Proof.
  ...
  - intros m E. destruct m as [| m'].
    + simpl in E. discriminate E.
    + simpl in E. rewrite <- plus_n_Sm in E. rewrite <- plus_n_Sm in E.
      injection E as E. f_equal. apply IHn. apply E.
Qed.
(** [] *)
...
Proof.
  ...
  induction l.
  - intros n El. reflexivity.
  - destruct n as [| n'].
    + intros contra. discriminate contra.
    + simpl. intros El. injection El as El. apply IHl. apply El.
Qed.
(** [] *)
...
Proof.
  ...
  - intros l1 l2. simpl. intros E. injection E as E1 E2.
    rewrite <- E1. rewrite <- E2. reflexivity.
  - intros l1 l2. destruct x as [f s].
    intros Es. simpl in Es. destruct (split l). injection Es as El1 El2.
    rewrite <- El1. rewrite <- El2. simpl. 
...
Theorem eqb_trans : forall n m p,
  ...
  n =? p = true.
Proof.
  intros n m p Enm Emp. apply eqb_true in Enm. apply eqb_true in Emp.
  rewrite Enm. rewrite Emp. apply eqb_refl.
Qed.
(** [] *)
...
Proof.
  ...
  - intros l2. destruct l2.
    + simpl. intros contra. discriminate contra.
    + simpl. intros El. injection El as El. apply IHl1 in El. 
...
Proof.
  ...
  - intros lf contra. discriminate contra.
  - intros lf. simpl. destruct (test x0) eqn:Et.
    + intros Ef. injection Ef as Ex _. rewrite <- Ex. apply Et.
    + apply IHl.
Qed.
(** [] *)
