...
Theorem t_update_neq : forall (A : Type) (m : total_map A) x1 x2 v,
  ...
  (x1 !-> v ; m) x2 = m x2.
Proof.
  intros A m x1 x2 v Hne. unfold t_update. apply eqb_neq in Hne. rewrite Hne.
  reflexivity.
Qed.
(** [] *)
...
Proof.
  ...
  intros x0. destruct (x =? x0)%string.
  - reflexivity.
  - reflexivity.
Qed.
(** [] *)
...
Theorem t_update_permute : forall (A : Type) (m : total_map A)
  ...
  (x2 !-> v2 ; x1 !-> v1 ; m).
Proof.
  intros A m v1 v2 x1 x2 Hne. apply functional_extensionality. intros x.
  unfold t_update. destruct (eqb_spec x1 x).
  - destruct (eqb_spec x2 x).
    + rewrite <- e in e0. destruct (Hne e0).
    + reflexivity.
  - reflexivity.
Qed.  
(** [] *)
