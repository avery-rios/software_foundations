...
Proof.
  intros b c.
  destruct b.
  - simpl. intros Hc. rewrite Hc. reflexivity.
...
Proof.
  ...
  - destruct l.
    ...
    + reflexivity.
    + reflexivity.
    + rewrite lower_grade_F_Minus. rewrite Hf. reflexivity.
Qed.
...
Proof.
  intros ld g Hl.
  rewrite apply_late_policy_unfold. rewrite Hl. reflexivity.
Qed.
...
Proof.
  intros ld g Hd1 Hd2 Hf.
  rewrite apply_late_policy_unfold. rewrite Hd1. rewrite Hd2. reflexivity.
Qed.
